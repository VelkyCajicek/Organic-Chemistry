...
class CyclicalHydrocarbon:
    ...
    def DrawCyclicalHydrogen(self, t : Tivy, mainCarbonCount : int, compoundData : list, bondPositions : list):
    ...
    def DrawHydrocarbonResidueCyclical(self, currentAngle : float, t : Tivy, compoundDataElement : int): # This needs reworking
        currentPosX = t.xcor()
        currentPosY = t.ycor()
    ...
    def DrawCyclicalHydrogenAdditionalInfo(self, compoundData : list, i : int, t : Tivy):
        currentHeading = t.heading()
